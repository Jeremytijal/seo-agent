        ...
        <div className="landing-outrank">
            ...
            <section className="hero-outrank">
                ...
                <div className="hero-content-outrank">
                    ...
                    <h1>
                        0 à 10K visites organiques<br />
                        <span className="gradient-text">en 90 jours grâce à l'IA</span>
                    </h1>
                    
                    <p className="hero-desc">
                        Multipliez votre trafic organique avec une stratégie de contenu SEO automatisée. 
                        Notre IA génère des articles optimisés qui rankent sur Google et génèrent du trafic qualifié.
                    </p>
                ...
                <div className="section-container">
                    <div className="stats-grid-outrank">
                        <div className="stat-outrank">
                            <span className="stat-value-big">10K</span>
                            <span className="stat-label">Visites en 90 jours</span>
                        </div>
                        <div className="stat-outrank">
                            <span className="stat-value-big">500%</span>
                            <span className="stat-label">Croissance trafic</span>
                        </div>
                        <div className="stat-outrank">
            ...
            <section className="cta-outrank">
                <div className="cta-container-outrank">
                    ...
                    <h2>Prêt à exploser votre trafic ?</h2>
                    <p>Rejoignez les créateurs qui génèrent 10K visites organiques en 90 jours.</p>
