            ...
            <div className="legal-container">
                ...
                <div className="legal-content">
                    <section className="intro-section">
                        <p>
                            Chez Agent IA SEO, la protection de vos données personnelles est une priorité. Cette politique 
                    ...
                    <section>
                        ...
                        <div className="info-box">
                            <p><strong>Agent IA SEO</strong></p>
                            <p>Paris, France</p>
                            <p>Email : <a href="mailto:privacy@agentiaseo.com">privacy@agentiaseo.com</a></p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="note">
                            <strong>Note :</strong> Pour ces données, vous restez responsable du traitement et Agent IA SEO 
                    ...
                    <section>
                        ...
                        <p>
                            Pour exercer ces droits, contactez-nous à : <a href="mailto:privacy@agentiaseo.com">privacy@agentiaseo.com</a>
                        </p>
                        <p>
                    ...
                    <section>
                        ...
                        <p>
                            Agent IA SEO intègre une fonctionnalité de gestion des préférences conforme au RGPD. Vous pouvez 
                            à tout moment demander la suppression de vos données ou vous désabonner de nos communications.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="info-box">
                            ...
                            <p>Email : <a href="mailto:dpo@agentiaseo.com">dpo@agentiaseo.com</a></p>
                        </div>
                    </section>
                </div>
