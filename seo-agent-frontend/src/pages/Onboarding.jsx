...
const Onboarding = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        objections: [
            ...
            { objection: "J'ai déjà un commercial", response: "Agent IA SEO l'assiste, ne le remplace pas" },
    ...
    const [analysisData, setAnalysisData] = useState({
        ...
        faqs: [
            ...
            "Comment s'intègre Agent IA SEO avec mon CRM ?",
    ...
    const guideContent = {
        0: {
            why: "Agent IA SEO analyse votre site web pour comprendre votre activité, votre audience et le contexte entrant. Cela garantit que l'agent s'aligne sur votre ton et le type de leads que vous recevez.",
        ...
        1: {
            why: "Nous affichons ce que Agent IA SEO a détecté pour que vous puissiez confirmer le contexte avant de générer le comportement de l'agent.",
                                    ...
                                    <div className="profile-grid">
                                        <div className="profile-item editable">
                                            ...
                                            {editMode.profile ? (
                                                <input
                                                    type="text"
                                                    value={analysisData?.companyName || "Agent IA SEO"}
                                                    onChange={(e) => setAnalysisData({ ...analysisData, companyName: e.target.value })}
                                                    className="editable-input"
                                                />
                                            ) : (
                                                <span className="profile-value">{analysisData?.companyName || "Agent IA SEO"}</span>
                                            )}
                                        </div>
                        ...
                        <motion.div key="step6" variants={variants} initial="enter" animate="center" exit="exit" className="step-wrapper wide">
                            <div className="integration-container">
                                ...
                                <div className="integrations-grid">
                                    {/* Agent IA SEO - Connected */}
                                    <div className="integration-card connected">
                                        <div className="card-header">
                                            <div className="integration-card-title">
                                                <div className="integration-icon seo-agent">
                                                    <Rocket size={20} />
                                                </div>
                                                <h3>Agent IA SEO</h3>
                                            </div>
                                        ...
                                        <p className="card-desc">
                                            Vous pouvez déjà gérer vos leads dans Agent IA SEO. Toutes les données sont synchronisées automatiquement.
                                        </p>
                                    </div>
                                        ...
                                        <div className="activation-checklist">
                                            ...
                                            <div className="checklist-items">
                                                ...
                                                <div className={`checklist-item checked`}>
                                                    <CheckCircle2 size={18} />
                                                    <span>Agent IA SEO connecté</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="getstarted-options">
                                    ...
                                    <div className="getstarted-card">
                                        ...
                                        <p className="card-description">
                                            Intégrez Agent IA SEO à vos formulaires existants via webhook.
                                            Chaque nouveau lead sera automatiquement contacté.
                                        </p>

                                        <div className="webhook-section">
                                            <label>Votre webhook Agent IA SEO :</label>
