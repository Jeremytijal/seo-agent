...
const WebhookDocs = () => {
  ...
  "message": "Je souhaite en savoir plus sur vos services"
    ...
    const curlExample = `curl -X POST https://api.agentiaseo.com/webhooks/VOTRE_ID/leads \\
            ...
            <div className="webhook-docs-container">
                ...
                <div className="docs-header">
                    ...
                    <p className="docs-subtitle">
                        Intégrez Agent IA SEO à vos outils existants
                    </p>
                </div>
                ...
                <div className="docs-content">
                    ...
                    <section className="docs-section">
                        ...
                        <p>
                            Envoyez vos données à Agent IA SEO via une simple requête HTTP POST. 
                            Notre agent IA traitera automatiquement vos demandes de contenu.
                        </p>
                        
                        <div className="endpoint-box">
                            <span className="method">POST</span>
                            <code>https://api.agentiaseo.com/webhooks/<span className="highlight">VOTRE_ID</span>/leads</code>
                        </div>
