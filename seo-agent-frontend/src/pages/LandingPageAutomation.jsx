        ...
        <div className="landing-outrank">
            ...
            <section className="hero-outrank">
                ...
                <div className="hero-content-outrank">
                    ...
                    <h1>
                        Publie 30 articles SEO/mois<br />
                        <span className="gradient-text">sans lever le petit doigt</span>
                    </h1>
                    
                    <p className="hero-desc">
                        Automatisez complètement votre stratégie de contenu SEO. L'IA génère, optimise et publie 
                        vos articles sur WordPress pendant que vous vous concentrez sur votre business.
                    </p>
            ...
            <section className="cta-outrank">
                <div className="cta-container-outrank">
                    ...
                    <p>Rejoignez les créateurs qui publient 30 articles/mois sans effort.</p>
...
export default LandingPageAutomation;
