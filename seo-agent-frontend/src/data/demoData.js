// Demo data for Agent IA SEO dashboard
...
export const demoConversations = [
    {
        ...
        messages: [
            ...
            { role: 'assistant', content: 'Bonjour Jean ! Merci pour votre intérêt 🙂 Je suis Sophie, assistante IA chez Agent IA SEO. Pour mieux comprendre vos besoins, combien de leads recevez-vous par mois actuellement ?', created_at: new Date(Date.now() - 2 * 60 * 60 * 1000 + 30000).toISOString() },
            ...
            { role: 'assistant', content: 'Je comprends, c\'est un défi courant. Avec Agent IA SEO, on peut répondre en moins de 5 minutes 24/7. Êtes-vous le décideur pour ce type de solution ?', created_at: new Date(Date.now() - 1 * 60 * 60 * 1000 + 20000).toISOString() },
    ...
    },
    {
        ...
        messages: [
            ...
            { role: 'assistant', content: 'Bonjour Marie ! Agent IA SEO est un agent IA qui répond automatiquement à vos leads par SMS. On qualifie, on prend des RDV et on synchronise avec votre CRM. Quel est votre secteur d\'activité ?', created_at: new Date(Date.now() - 5 * 60 * 60 * 1000 + 28000).toISOString() },
            ...
            { role: 'assistant', content: 'C\'est énorme ! 😱 Avec Agent IA SEO, 100% de vos leads reçoivent une réponse en moins de 5 min. On peut faire une démo ?', created_at: new Date(Date.now() - 4 * 60 * 60 * 1000 + 20000).toISOString() },
    ...
    },
    {
        ...
        messages: [
            ...
            { role: 'user', content: 'Un ami CEO d\'une fintech qui utilise Agent IA SEO depuis 3 mois.', created_at: new Date(Date.now() - 35 * 60 * 60 * 1000).toISOString() },
...
export const demoAgentConfig = {
    ...
    language: 'Français',
    agentPersona: {
        firstMessage: 'Bonjour {{name}} ! Merci pour votre intérêt 🙂 Je suis Sophie, assistante IA chez Agent IA SEO. Comment puis-je vous aider ?'
    }
};

// Demo email for identification
export const DEMO_EMAIL = 'demo@agentiaseo.com';
